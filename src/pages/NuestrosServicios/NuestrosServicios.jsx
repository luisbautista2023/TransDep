      ...
      <div className="n-servi-container">
        ...
        <div className="n-servi-cards">
          ...
          <div className="n-servi-card">
            ...
            <img className="card-fondo" src="https://cdn.pixabay.com/photo/2014/06/04/16/43/passenger-362169_1280.jpg" alt="escolar" />
          </div>

          <div className="n-servi-card">
            <h3 className="card-texto"> Transporte Usuarios de la Salud.</h3>
            <img  className="card-fondo" src="https://cdn.pixabay.com/photo/2019/04/09/10/40/dlrg-4114112_1280.jpg" alt="escolar" />
          </div>

          <div className="n-servi-card">
            <h3 className="card-texto">Transporte Turístico.</h3>
            <img  className="card-fondo" src="https://cdn.pixabay.com/photo/2019/07/20/14/46/bicycle-4350883_1280.jpg" alt="escolar" />
          </div>
        </div>
      </div>
    </>
